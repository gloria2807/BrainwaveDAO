    ...
    <div className='w-full flex md:flex-row flex-col items-center justify-between md:px-[120px] px-5 md:h-[calc(100vh-80px)] relative md:pb-0 pb-20'>
        <div className='flex flex-col gap-6 px-4 md:mt-0 mt-5'>
            ...
            <div data-aos="fade-up" duration="600" className="flex items-center gap-5">
                <button className='bg-primary text-black text-center cursor-pointer rounded-[40px] w-[120px] h-[50px]  hover:text-primary hover:bg-black hover:border-b-2 hover:border-amber-200'>
                    Join the DAO
                </button>
                <button className='text-white border-b-2 border-amber-100 text-center cursor-pointer rounded-[40px] w-[160px] h-[50px] hover:text-primary hover:bg-black hover:border-b-2 hover:border-primary'>
                    Learn How It Works
                </button>
            </div>
        </div>
